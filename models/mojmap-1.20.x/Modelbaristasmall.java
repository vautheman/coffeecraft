...
public class Modelbaristasmall<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "baristasmall"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = Head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 5)
						.addBox(-8.5F, -3.0F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(3, 0)
						.addBox(-8.5F, -1.0F, -7.5F, 1.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(-2, -8)
						.addBox(-0.5F, -1.0F, -7.5F, 1.0F, 1.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, -6.0F, 0.0F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 4)
						.addBox(-7.5F, -1.0F, 0.5F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(3, -3)
						.addBox(3.5F, -1.0F, 0.5F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition tablierbottom = Body.addOrReplaceChild("tablierbottom",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(-3.0F, -11.0F, -2.75F, 6.0F, 3.0F, 0.25F, new CubeDeformation(0.0F)).texOffs(0, 23)
		...
		PartDefinition tabliertop2 = Body.addOrReplaceChild("tabliertop2",
				CubeListBuilder.create().texOffs(0, 21)
						.addBox(0.5F, 6.0F, -12.75F, 8.0F, 5.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 21)
						...
						.addBox(1.5F, -1.0F, -12.75F, 1.0F, 7.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 21)
						.addBox(6.5F, -1.0F, -12.75F, 1.0F, 7.0F, 0.5F, new CubeDeformation(0.0F)).texOffs(0, 21)
