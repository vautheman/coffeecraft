...
public class CoffeePlantStage6TopLorsDunClicDroitSurLeBlocProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (random >= 0.8) {
			...
			world.setBlock(BlockPos.containing(x, y, z), CoffeecraftModBlocks.COFFEE_PLANT_STAGE_4_TOP.get().defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x, y - 1, z), CoffeecraftModBlocks.COFFEE_PLANT_STAGE_4_BOTTOM.get().defaultBlockState(), 3);
