...
public class GrinderGuiClosedProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((new Object() {
			...
			if (entity instanceof Player _player) {
				...
				}.getItemStack(world, BlockPos.containing(x, y, z), 6)).getCount());
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 7)).getCount() >= 1) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = ((new Object() {
					public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				...
				}.getItemStack(world, BlockPos.containing(x, y, z), 7)).getCount());
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 8)).getCount() >= 1) {
			if (entity instanceof Player _player) {
				ItemStack _setstack = ((new Object() {
					public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				...
				}.getItemStack(world, BlockPos.containing(x, y, z), 8)).getCount());
				ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
			}
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 9)).getCount() >= 1) {
			{
				BlockEntity _ent = world.getBlockEntity(BlockPos.containing(x, y, z));
				if (_ent != null) {
					final int _slotid = 9;
					...
					}.getItemStack(world, BlockPos.containing(x, y, z), 9)).getCount();
					_ent.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> {
						if (capability instanceof IItemHandlerModifiable) {
							ItemStack _stk = capability.getStackInSlot(_slotid).copy();
							_stk.shrink(_amount);
