...
import net.mcreator.coffeecraft.procedures.CroissantPoseProcedure;
...
public class CroissantItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		CroissantPoseProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
