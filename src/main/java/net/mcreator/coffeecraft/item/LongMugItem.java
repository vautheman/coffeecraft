...
import net.mcreator.coffeecraft.procedures.LungoEffectProcedure;
import net.mcreator.coffeecraft.init.CoffeecraftModBlocks;

import java.util.List;

public class LongMugItem extends Item {
	public LongMugItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		LungoEffectProcedure.execute(world, x, y, z, entity);
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		LungoPoseProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
