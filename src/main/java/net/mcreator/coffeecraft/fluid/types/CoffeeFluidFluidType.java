...
package net.mcreator.coffeecraft.fluid.types;
...
public class CoffeeFluidFluidType extends FluidType {
	public CoffeeFluidFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("coffeecraft:block/coffee-stil-texture"), FLOWING_TEXTURE = new ResourceLocation("coffeecraft:block/coffee-flow-texture");
