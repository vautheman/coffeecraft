...
public class GrinderAnimTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public GrinderAnimTileEntity(BlockPos pos, BlockState state) {
		super(CoffeecraftModBlockEntities.GRINDER_ANIM.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<GrinderAnimTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<GrinderAnimTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("grinder_anim");
	}
