package net.mcreator.coffeecraft.block.entity;
...
public class RoasterAnimatedTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public RoasterAnimatedTileEntity(BlockPos pos, BlockState state) {
		super(CoffeecraftModBlockEntities.ROASTER_ANIMATED.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RoasterAnimatedTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RoasterAnimatedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("roaster_animated");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new RoasterGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
